...
Scripts are numbered 00–06 and must be run in order. See [scripts/README.md](scripts/README.md) for full documentation of each script's inputs, outputs, and logic.

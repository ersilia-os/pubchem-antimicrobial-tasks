...
if not os.path.exists(os.path.join(outpath, "05_curate_bioassays", p)):
    os.makedirs(os.path.join(outpath, "05_curate_bioassays", p))
...
c.save_df(df, os.path.join(outpath, "05_curate_bioassays", f"{p.lower()}"))
c.get_description(os.path.join(outpath, "05_curate_bioassays", f"{p.lower()}"))
